/**
 * Minimal Uniswap v3 tick math.
 *
 * Uniswap v3 prices are powers of 1.0001 over an integer tick. For
 * human-readable prices we divide out the token decimal difference.
 */
...
export function distanceFromBoundary(
  tick: number,
  tickLower: number,
  tickUpper: number,
): number {
